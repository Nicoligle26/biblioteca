...
editorials = [
  { id: 1, name: 'Salamandra', city: 'España', pages: 'https://www.penguinlibros.com/es' },
  { id: 2, name: 'Planeta', city: 'España',
    pages: 'https://www.planetadelibros.com/editorial/editorial-planeta/8' },
  { id: 3, name: 'Sin fronteras', city: 'Venezuela', pages: 'https://www.gruposinfronteras.com/' }
]
genders = [
  { id: 1, name: 'Juvenil', editorial_id: 1 },
  { id: 2, name: 'Libros de literatura', editorial_id: 3 },
  { id: 3, name: 'Juvenil', editorial_id: 3 }
]

authors = [
  { id: 1, name: 'J.K. Rowling', nationality: 'Reino unido' },
  { id: 2, name: 'Blue Jeans', nationality: 'Sevilla, España' },
  { id: 3, name: 'Nacarid Porta;', nationality: 'Venezuela' }
]

books = [
  { id: 1, name: 'Harry Potter y la Piedra Filosofal', price: '$96.739',
  ...
  { id: 3, name: 'La Vida Entre mis Dedos', price: '$55.920',
    ...
    image: 'https://image.cdn0.buscalibre.com/5c0570f958e473bb458b4567.__RS360x360__.jpg', author_id: 3, gender_id: 3 }
]
